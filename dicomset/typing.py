...
BatchLabelMap2D = Int[np.ndarray, "B X Y"]
BatchLabelMap3D = Int[np.ndarray, "B X Y Z"]
BatchPoints2D = Float[np.ndarray, "B N 2"]
BatchPoints3D = Float[np.ndarray, "B N 3"]
BatchPixels = Int[np.ndarray, "B N 2"] 
BatchPixelBox = Int[np.ndarray, "B 2 2"]
BatchVoxels = Int[np.ndarray, "B N 3"]
...
DatasetID = str
DatasetType = Literal['d', 'dicom', 'n', 'nifti', 'r', 'raw', 't', 'training']
...
LabelMap2D = Int[np.ndarray, "X Y"]
LabelMap3D = Int[np.ndarray, "X Y Z"]
...
Number = int | float
Orientation2D = str  # E.g. LS, RI, etc.
Orientation3D = str  # E.g. LPS, RAI, etc.
...
BatchLabelMap = BatchLabelMap2D | BatchLabelMap3D
